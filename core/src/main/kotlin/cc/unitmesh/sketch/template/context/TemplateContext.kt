package cc.unitmesh.sketch.template.context

/**
 * `TemplateContext` is an interface used to provide data to the template rendering process in the `cc.unitmesh.sketch.template.TemplateRender` class. It serves as a container for the data that should be made available within the template for use in the rendering process.
 *
