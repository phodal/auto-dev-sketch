...
import cc.unitmesh.sketch.settings.locale.DEFAULT_HUMAN_LANGUAGE
import cc.unitmesh.sketch.settings.locale.HUMAN_LANGUAGES
import cc.unitmesh.sketch.settings.miscs.MAX_TOKEN_LENGTH
...
@State(name = "cc.unitmesh.sketch.settings.DevtiSettingsState", storages = [Storage("DevtiSettings.xml")])
