 ...
 */
package cc.unitmesh.sketch.diff
...
class VerticalDiffBlock(
    ...
    private fun createButtons(): Pair<JButton, JButton> {
        val rejectBtn =
            createButton(
                cc.unitmesh.sketch.AutoDevBundle.message("sketch.patch.action.reject"),
        ...
        val acceptBtn =
            createButton(
                cc.unitmesh.sketch.AutoDevBundle.message("sketch.patch.action.accept"),
