package cc.unitmesh.sketch.sketch.ui.code.processor
...
import cc.unitmesh.sketch.sketch.ui.patch.DiffLangSketch
...
class EditFileCommandProcessor(private val project: Project) {
    ...
    fun executeEditFileCommandAsync(
        ...
        try {
            ...
            val editFileCommand = cc.unitmesh.sketch.command.EditFileCommand(project)
