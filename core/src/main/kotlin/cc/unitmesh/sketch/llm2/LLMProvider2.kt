package cc.unitmesh.sketch.llm2

import cc.unitmesh.sketch.llms.custom.CustomRequest
import cc.unitmesh.sketch.llms.custom.Message
import cc.unitmesh.sketch.llms.custom.Usage
import cc.unitmesh.sketch.llms.custom.appendCustomHeaders
...
abstract class LLMProvider2 protected constructor(
    ...
    companion object {
         ...
         */
        fun fromConfig(llmConfig: cc.unitmesh.sketch.llm2.model.LlmConfig, project: Project? = null): LLMProvider2 {
