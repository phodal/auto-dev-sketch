package cc.unitmesh.sketch.agent.a2a

import cc.unitmesh.sketch.a2a.AgentCapabilities
import cc.unitmesh.sketch.a2a.AgentProvider
import cc.unitmesh.sketch.a2a.AgentSkill
import cc.unitmesh.sketch.a2a.ToolAgentCard
import cc.unitmesh.sketch.a2a.ToolInput
...
class ToolAgentCardTest {
    ...
    fun `should inherit from Tool interface`() {
        ...
        assertTrue(card is cc.unitmesh.sketch.agent.Tool)
        assertEquals("TestAgent", card.name)
